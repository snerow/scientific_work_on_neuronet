...
try:
    ...
    gameover_sound = mixer.Sound('tetris_data/gameover.wav') if os.path.exists(
        'tetris_data/gameover.wav') else DummySound()
except:
...
class Game:
    ...
    def draw_menu(self):
        ...
        scores_rect = scores_text.get_rect(
            center=(screen_width // 2, button_y + button_height + 20 + button_height // 2))
    ...
    def run(self):
        ...
        while running:
            ...
            if self.state == "menu":
                ...
                # Обновление частиц (если они есть)
                self.update_particles(dt)
                self.draw_particles()
